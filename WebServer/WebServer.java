...
public class WebServer {
    ...
    private void handleSearchTokenRequest(HttpExchange exchange) throws IOException {
        ...
        // Extracción de parámetros para la generación de la cadena y búsqueda de la
        // subcadena
        ...
        long finishTime = System.nanoTime(); // Final del contador de tiempo
        if (isDebugMode) {
            long durationInNanos = finishTime - startTime;
            String debugMessage = String.format("La operación tomó %d nanosegundos", durationInNanos);
            exchange.getResponseHeaders().set("X-Debug", debugMessage); // Corregido aquí
        }
    ...
    private void handleTaskRequest(HttpExchange exchange) throws IOException {
        ...
        // Obtiene las cabeceras de la solicitud
        Headers headers = exchange.getRequestHeaders();
        // Imprime la cantidad de headers recibidos
        int numHeaders = headers.size();
        System.out.println("Número de headers recibidos: " + numHeaders);
        // Imprime todos los headers (key - value) contenidos en la solicitud
        ...
        // Verifica si la cabecera "X-Test" es "true" y responde con una cadena de prueba
        ...
        byte[] requestBytes = exchange.getRequestBody().readAllBytes();
        System.out.println(new String(requestBytes)); // Imprime el cuerpo
        ...
        if (isDebugMode) {
            ...
            String debugMessage = String.format("La operacion tomo %d nanosegundos = %d segundos con %d milisegundos",
                    durationInNanos, durationInSeconds, millisPart);
